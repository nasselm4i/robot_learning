CONFIGS=(
    ...
    "env.exp_name=q4_reacher_ensemble3 env.env_name=cheetah-roble-v0 alg.num_agent_train_steps_per_iter=500 alg.network.layer_sizes=[32]"
...
WORKSPACE_FOLDER=/teamspace/studios/this_studio/MILA/robot_learning
for CONFIG in "${CONFIGS[@]}"; do
    /home/zeus/miniconda3/envs/cloudspace/bin/python $WORKSPACE_FOLDER/run_hw2_mb.py $CONFIG
done
